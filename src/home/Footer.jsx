    ...
    <div className="w-full relative rounded-lg shadow z-10">
        <div className="flex flex-row items-start gap-4 mx-4 py-4">
            <span className="flex text-sm text-gray-500 dark:text-gray-400"> 
                Developed with <FontAwesomeIcon className="mx-1 mt-1 text-sm text-red-800" icon={faHeart} /> by {PROPERTIES.first_name} {PROPERTIES.last_name} | {PROPERTIES.occupation_start_year} - {new Date().getFullYear()}
            </span>
    ...
    <div className="w-full flex flex-col justify-center">  
        <div className="flex w-full py-2 border-t border-divider justify-self-center">
            <span className="w-full text-sm text-gray-500 text-center dark:text-gray-400"> 
                        Developed with <FontAwesomeIcon className="text-red-800" icon={faHeart} /> by {PROPERTIES.first_name} {PROPERTIES.last_name} | {PROPERTIES.location_abbrv}<FontAwesomeIcon className="text-red-800 ml-1" icon={faCanadianMapleLeaf} />
                    </span>
            </div>
